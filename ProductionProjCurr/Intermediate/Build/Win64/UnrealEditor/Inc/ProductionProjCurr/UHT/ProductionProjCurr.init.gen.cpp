...
void EmptyLinkFunctionForGeneratedCodeProductionProjCurr_init() {}
	...
	PRODUCTIONPROJCURR_API UFunction* Z_Construct_UDelegateFunction_ProductionProjCurr_OnBuildingPlaced__DelegateSignature();
	PRODUCTIONPROJCURR_API UFunction* Z_Construct_UDelegateFunction_ProductionProjCurr_OnDevTurnChanged__DelegateSignature();
	PRODUCTIONPROJCURR_API UFunction* Z_Construct_UDelegateFunction_ProductionProjCurr_OnEndPhaseStarted__DelegateSignature();
	PRODUCTIONPROJCURR_API UFunction* Z_Construct_UDelegateFunction_ProductionProjCurr_OnEndPhaseTurn__DelegateSignature();
	...
	PRODUCTIONPROJCURR_API UFunction* Z_Construct_UDelegateFunction_ProductionProjCurr_OnPlayerWon__DelegateSignature();
	PRODUCTIONPROJCURR_API UFunction* Z_Construct_UDelegateFunction_ProductionProjCurr_OnResourcesChanged__DelegateSignature();
	...
	PRODUCTIONPROJCURR_API UFunction* Z_Construct_UDelegateFunction_ProductionProjCurr_OnTroopDeselected__DelegateSignature();
	PRODUCTIONPROJCURR_API UFunction* Z_Construct_UDelegateFunction_ProductionProjCurr_OnTroopSelected__DelegateSignature();
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_ProductionProjCurr()
	{
		if (!Z_Registration_Info_UPackage__Script_ProductionProjCurr.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_ProductionProjCurr_OnBuildingPlaced__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ProductionProjCurr_OnDevTurnChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ProductionProjCurr_OnEndPhaseStarted__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ProductionProjCurr_OnEndPhaseTurn__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_ProductionProjCurr_OnPlayerWon__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ProductionProjCurr_OnResourcesChanged__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_ProductionProjCurr_OnTroopDeselected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ProductionProjCurr_OnTroopSelected__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_ProductionProjCurr(Z_Construct_UPackage__Script_ProductionProjCurr, TEXT("/Script/ProductionProjCurr"), Z_Registration_Info_UPackage__Script_ProductionProjCurr, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x7BAD4B7E, 0xB13058F9));
